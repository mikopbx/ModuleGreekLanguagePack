...
namespace Modules\ModuleGreekLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Greek Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Greek UI translations from Messages/el/ directory
 * - Greek voice prompts from Sounds/gr-gr/ directory
 *
 ...
 *
 * @package Modules\ModuleGreekLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleGreekLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Greek packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Greek Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Greek Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Greek Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Greek Language Pack uninstalled successfully',
            LOG_INFO
        );
